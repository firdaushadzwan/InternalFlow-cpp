...
void InternalFlow::calculateDensity() {
    for (int i = 0; i < numCases; i++) {
...
void InternalFlow::dynamicViscositySelection() {
    for (int i = 0; i < 10; i++) {
        if (temperature[i] <= 0) {
...
void InternalFlow::ReynoldNumber() {
    for (int i = 0; i < numCases; i++) {
        Re[i] = (density[i] * avgVelocity[i] * diameter[i]) / dynamicViscosity[i];
    }
}

void InternalFlow::frictionFactor() {
    for (int i = 0; i < numCases; i++) {
...
void InternalFlow::mainCalculation() {
    for (int i = 0; i < numCases; i++) {
...
void InternalFlow::displayOutput(int caseIndex) {
